...
@NgModule({ declarations: [
    ...
    bootstrap: [AppComponent], imports: [BrowserModule,
        ...
        MatDialogModule,
        MatSnackBarModule,
        NgChartsModule], providers: [UploadInventoryservice, { provide: HTTP_INTERCEPTORS, useClass: AuthInterceptor, multi: true }, { provide: HTTP_INTERCEPTORS, useClass: LoadingInterceptor, multi: true }, {
            provide: MAT_SNACK_BAR_DEFAULT_OPTIONS,
            useValue: { panelClass: ['mycsssnackbartest'] },
        },
        SignInService, Registerservice, EditProfileService, SessionService, provideHttpClient(withInterceptorsFromDi())] })
